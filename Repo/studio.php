...
nav.horiz ul li {float:left; padding: 5px 10px; list-style:none; text-align: bottom; font-size: 24px; link-color:red;}
table, th, td {
...
<nav id = "studio">
<p style="color:red;font-size:24px">STUDIO'S</p>
<?php
$host="localhost";
$port=3306;
$socket="";
...
//$con->close();
$sql = "SELECT studio.studio_Name, anime.Name_ENG FROM studio JOIN anime WHERE anime.studio_ID =  studio.studio_ID;";
